...
/*
 ...
 ------------------------------------------------------------
*/
INSERT INTO site (site_number, campground_id)VALUES('623', '4')
INSERT INTO site (site_number, campground_id)VALUES('624', '4')
INSERT INTO site (site_number, campground_id)VALUES('625', '4')
 ...
 */
 UPDATE reservation SET from_date = GETDATE(), to_date = GETDATE()+ 7 WHERE name = 'Wayne Family'
