...
SELECT * FROM site WHERE utilities = 1 ORDER BY max_rv_length DESC

-- select total number of sites that have utilities hook up (expected: around 25)
SELECT site_number FROM site WHERE utilities = 1


-- RESERVATION TABLE
-----------------------------------------------
SELECT from_date, to_date FROM reservation ORDER BY from_date
...
SELECT reservation_id, site_id, name, from_date, to_date FROM reservation WHERE from_date >= '2023-02-01' AND to_date < '2023-03-01'
